...
public class PlanServiceTest {
	...
	public void testCheckDate1() {
		...
		assertEquals(svc.checkDate(plan), constants.VALID_MESSAGE);
	}

	@Test
	public void testCheckDate2() {
		Mockito.when(plan.getStartDate()).thenReturn(startDate2);
		assertEquals(constants.DATE_PAST_MESSAGE, svc.checkDate
	...
	public void testCheckDate3() {
		...
		assertEquals(constants.END_BEFORE_START_MESSAGE,svc.checkDate(plan));
	}

	@Test
	public void testCheckAvailable() {
		assertEquals(svc.checkAvailible(plan1, plans),constants.VALID_MESSAGE);
	}

	@Test
	public void testCheckAvailable2() {
			plan1.setRoomNumber("7");
		assertEquals(svc.checkAvailible(plan1, plans),constants.ROOM_BOOKED);
	}

	@Test
	public void testCheckAvailable3() {
		assertEquals(svc.checkAvailible(clashPlan, plans), constants.TRAINER_BUSY);
	}

	@Test
	public void testCheckValid() {
		assertEquals(svc.checkValid(plan2, plans),constants.ROOM_BOOKED);
	}

	@Test
	public void testCheckValid2() {
		assertEquals(svc.checkValid(plan1,plans), constants.DATE_PAST_MESSAGE);
	}

	@Test
	public void testCheckValid3() {
		assertEquals(svc.checkValid(clashPlan,plans), constants.TRAINER_BUSY);
	}
